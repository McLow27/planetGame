...
public class MarkdownOld extends Panel {
    ...
    public MarkdownOld(Dimension dimension, Font font, String markdown) {
        super(dimension);
        this.font = font;
    ...
    public MarkdownOld(Dimension dimension, Font font, File markdown) throws FileNotFoundException {
        super(dimension);
        this.font = font;
